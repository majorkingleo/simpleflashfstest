...
int main( int argc, char **argv )
{
	...
	try {
		...
		test_cases.push_back( test_case_static_TwoFace_truncate_enlarge() );
		test_cases.push_back( test_case_static_TwoFace_truncate_shrink_inline() );
		test_cases.push_back( test_case_static_TwoFace_truncate_shrink_external() );
		test_cases.push_back( test_case_static_TwoFace_truncate_shrink_page_to_inline_size() );
		test_cases.push_back( test_case_static_TwoFace_truncate_to_zero() );
		...
		test_cases.push_back( test_case_simple_ini_write_11() );

...
int main( int argc, char **argv )
{
	...
	try {
		...
		// Mirrors `two_drives_dynamic` test1: format/test_count/cat path,
		// without going through the C-style fopen/fwrite/fgets wrapper.
		test_cases.push_back( test_case_direct_test_count_cat() );
